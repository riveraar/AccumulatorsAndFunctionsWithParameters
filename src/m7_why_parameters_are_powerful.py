...
def run_test_even_better_draw_circles():
    even_better_draw_circles(15, 7, 0.2)
    even_better_draw_circles(5, 15, 0.1)
    even_better_draw_circles(8, 25, 0.5)


# x handles the amount of times a circle is created
# y handles the radii of each circle
# z handles the speed of creating the circles
